...
xst -ifn xst.scr
move SystemClockUnit_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\SystemClockUnit_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc SystemClockUnit_exdes.ucf SystemClockUnit_exdes

echo 'Running map'
map -timing -pr b SystemClockUnit_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm SystemClockUnit_exdes -w routed.ncd routed.v
cd ..
